...
class __TwigTemplate_063a0366f4ef07c62a7cfb9bf7fbc63b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 77, $this->source)))) : (""))];
        // line 80
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("bootstrap4/node"), "html", null, true);
        echo "
<article";
        // line 81
...
";
    ...
    {
        return new Source("", "themes/contrib/bootstrap4/templates/content/node.html.twig", "C:\\xampp\\htdocs\\drupal_site\\themes\\contrib\\bootstrap4\\templates\\content\\node.html.twig");
    }
